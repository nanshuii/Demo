...
-(UIView *)tipView{
    if (!_tipView) {
        _tipView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.diameter/4, self.diameter/4)];
        _tipView.backgroundColor = [UIColor greenColor];
        _tipView.layer.cornerRadius = self.diameter/8;
    }
    return _tipView;
}
